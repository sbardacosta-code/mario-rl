...
- [September 20 reliability check: 50 new attempts](../../results/reliability_20260920/README.md) — **Flag reached: 42/50 trials.** All 50 planned trials are complete. [Evaluation data](../../results/reliability_20260920/evaluation/evaluation.json).
