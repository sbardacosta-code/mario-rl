...
Between the first and last comparable stages, the mean maximum position **decreased: 3,175.0 → 3,087.9 pixels**. The last stage reached the flag in **19 of 20 trials**. This describes these trials on the same level; it does not establish general performance or consistent improvement.
